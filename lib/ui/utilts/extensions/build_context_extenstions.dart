...
extension BuildContextExtensions on BuildContext {
  ...
  ThemeProvider get themeProvider => Provider.of(this , listen: false ); /// انا عملت دية كمان عشان بردو مقعدش اعمل زي الي عاملوا في ال فايل ال splash وزي evently وكدا
  /// وطب اية هيا listen عملتها عشان اعرف اغير ما بين light or dark بس كدا
  LanguageProvider get languageProvider => Provider.of(this , listen:  false );
